...
class CitizensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create citizen" do
    assert_difference('Citizen.count') do
      post citizens_url, params: { citizen: { birth_date: @citizen.birth_date, cns: @citizen.cns, document_identifier: @citizen.document_identifier, email: @citizen.email, name: @citizen.name } }
    end
  ...
  test "should update citizen" do
    patch citizen_url(@citizen), params: { citizen: { birth_date: @citizen.birth_date, cns: @citizen.cns, document_identifier: @citizen.document_identifier, email: @citizen.email, name: @citizen.name } }
